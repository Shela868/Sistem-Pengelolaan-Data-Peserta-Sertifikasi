              ...
              <div class="card bg-info text-dark" style="border-radius: 2rem;">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="NIK" class="col-md-4 col-form-label text-md-center">{{ __('NIK') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="jenis_kelamin" class="col-md-4 col-form-label text-md-center">{{ __('Jenis Kelamin') }}</label>

                            <div class="col-md-8">
                                {{-- <input id="jenis_kelamin" type="text" class="form-control @error('jenis_kelamin') is-invalid @enderror" name="NIK" value="{{ old('jenis_kelamin') }}" required autocomplete="jenis_kelamin" autofocus>  --}}
